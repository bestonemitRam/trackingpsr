...
class OrderList extends StatelessWidget
 {
  ...
  OrderList({required this.item, required this.retailer_id});
                  ...
                  onTap: () {
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          title: Text('Alert'),
                          content: Text('Are you want to sure delete order'),
                          actions: <Widget>[
                            TextButton(
                              onPressed: () {
                            ...
                            TextButton(
                              onPressed: () {
                                controller.deleteProduct(item.orderId!);
